...
function getStatusLabel(status){const labels={pending:'Mesada pendiente',active:'Mesada activa'};return labels[String(status||'').toLowerCase()]||'Estado no definido';}
function getFrequencyLabel(frequency){const labels={daily:'Diaria',weekly:'Semanal',monthly:'Mensual'};return labels[String(frequency||'').toLowerCase()]||'Frecuencia no definida';}
